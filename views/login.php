            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="p-5">
                    ...
                    <form class="user" method="post" action="backend/login.php">
                        ...
                        <div class="alert alert-<?= $_SESSION["PAGE_INFO_TYPE"] ?> rounded" role="alert">
                            <strong><?= $_SESSION["PAGE_INFO"] ?></strong>
                        </div>
                        <?php clearPageInfo(); endif; ?>
                        <div class="form-group">
                            <input type="text" required name="username" class="form-control form-control-user" placeholder="Enter Username">
                        </div>
                        <div class="form-group">
